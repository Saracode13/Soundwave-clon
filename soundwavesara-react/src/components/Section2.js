...
function Section2() {
  return (
    ...
    <Container fluid className="background vh-100">
      ...
      <Container lg={8}
        style={{display: "flex", flexDirection: "row",paddingTop: "2em"}}
        className="Textlinks mt-5"
      >
        <Container>
          <Row>
            <Col>
              <h1 style={{ fontSize: "1.5em", fontWeight: "300", paddingTop: "3em"}} id="Discover">
                Discover new music
              </h1>
            </Col>
          </Row>
          <Row>
            <Col className="Buttons d-flex mt-3">
              <Button className="align-content-center" style={{ width: "40", height: "40" }} variant="dark">
                <img
        ...
        <Row>
          <Col lg={6}>
          <img className="layoutfoto"
            src={Covers}  style={{width: "16em", height: "16em" }}
          >
             </img>
             </Col>
        </Row>
